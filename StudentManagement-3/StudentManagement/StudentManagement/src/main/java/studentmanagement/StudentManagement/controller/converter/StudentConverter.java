...
public List<StudentDetail> convertStudentDetails(List<Student> students,List<Students_Courses> studentsCourses) {
  ...
  students.forEach(student -> {
    ...
    List<Students_Courses> convertStudentCourses = studentsCourses.stream()
        .filter(students_Course -> student.getId().equals(students_Course.getStudentId()))
